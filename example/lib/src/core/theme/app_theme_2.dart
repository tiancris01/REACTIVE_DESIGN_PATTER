...
class AppTheme2 extends ThemeExtension<AppTheme2> {
  ...
  @override
  ThemeExtension<AppTheme2> copyWith({
    AppColors? appColors,
    AppFonts? appFonts,
  }) {
    return AppTheme2(
  ...
  @override
  ThemeExtension<AppTheme2> lerp(
      covariant ThemeExtension<AppTheme2>? other, double t) {
    if (other is! AppTheme2) return this;
    return AppTheme2(
      appColors: AppColors(
